Robert Kane, Jr. Portfolio Site (Frontend)
...
The backend is in a separate repo that can be viewed here - https://github.com/robertkanejr/portfolio-backend
...
Dependencies: axios, bootstrap, dotenv, react, react-bootstrap, react-router-dom, react-slick, slick-carousel, emailjs
